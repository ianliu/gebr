...
static const GtkActionEntry actions_entries_flow[] = {
	...
	{"flow_properties", "kontact_todo", N_("Edit"),
		NULL, N_("Edit"), G_CALLBACK(on_document_properties_activate)},
	...
	{"flow_execute_parallel", GTK_STOCK_EXECUTE, N_("Run parallely"),
		"<Control><Shift>R", N_("Run parallely"), G_CALLBACK(on_flow_execute_parallel_activate)},
...
static const GtkActionEntry actions_entries_flow_edition[] = {
	...
	{"flow_edition_properties",  "kontact_todo", N_("Edit"),
		NULL, N_("Edit"), G_CALLBACK(on_flow_component_properties_activate)},
