...
struct ggopt
{
  ...
  int name_given ;	/**< @brief Whether name was given.  */
  int email_given ;	/**< @brief Whether email was given.  */
  int usermenus_given ;	/**< @brief Whether usermenus was given.  */
  int data_given ;	/**< @brief Whether data was given.  */
  int editor_given ;	/**< @brief Whether editor was given.  */
  int browser_given ;	/**< @brief Whether browser was given.  */
...
struct cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure ggopt (default 0) */
