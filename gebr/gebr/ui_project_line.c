...
{
	gebr.config.line_no_param_radio =  gtk_toggle_button_get_active (toggle);
}
static void on_detailed_line_flow_param_default_toggled (GtkToggleButton *toggle)
{
	gebr.config.line_just_default_radio =  gtk_toggle_button_get_active (toggle);
}
static void on_detailed_line_flow_param_filled_toggled (GtkToggleButton *toggle)
{
	gebr.config.line_just_filled_radio =  gtk_toggle_button_get_active (toggle);
}
static void on_detailed_line_flow_param_all_toggled (GtkToggleButton *toggle)
{
	gebr.config.line_all_param_radio =  gtk_toggle_button_get_active (toggle);
}
...
gebr_project_line_print_dialog_custom_tab()
{
	...
	detailed_line_css_combo = gtk_combo_box_new_with_model(GTK_TREE_MODEL(list_store));
	...
	GtkWidget *line_no_param_radio;
	GtkWidget *line_just_default_radio;
	GtkWidget *line_just_filled_radio;
	GtkWidget *line_all_param_radio;
	...
	line_no_param_radio = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(fake_radio), _("No table at all"));
	gtk_box_pack_start(GTK_BOX(param_vbox), line_no_param_radio, FALSE, FALSE, 2);

	line_just_default_radio = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(fake_radio), _("Just parameters which differ from default"));
	gtk_box_pack_start(GTK_BOX(param_vbox), line_just_default_radio, FALSE, FALSE, 2);

	line_just_filled_radio = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(fake_radio), _("Just filled in parameters"));
	gtk_box_pack_start(GTK_BOX(param_vbox), line_just_filled_radio, FALSE, FALSE, 2);

	line_all_param_radio = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(fake_radio), _("All parameters"));
	gtk_box_pack_start(GTK_BOX(param_vbox), line_all_param_radio, FALSE, FALSE, 2);

	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(line_no_param_radio), gebr.config.line_no_param_radio);
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(line_just_default_radio), gebr.config.line_just_default_radio);
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(line_just_filled_radio), gebr.config.line_just_filled_radio);
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(line_all_param_radio), gebr.config.line_all_param_radio);

	g_signal_connect(GTK_TOGGLE_BUTTON(line_no_param_radio), "toggled", G_CALLBACK(on_detailed_line_flow_param_none_toggled), NULL);
	g_signal_connect(GTK_TOGGLE_BUTTON(line_just_default_radio), "toggled", G_CALLBACK(on_detailed_line_flow_param_default_toggled), NULL);
	g_signal_connect(GTK_TOGGLE_BUTTON(line_just_filled_radio), "toggled", G_CALLBACK(on_detailed_line_flow_param_filled_toggled), NULL);
	g_signal_connect(GTK_TOGGLE_BUTTON(line_all_param_radio), "toggled", G_CALLBACK(on_detailed_line_flow_param_all_toggled), NULL);
