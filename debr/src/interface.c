...
static const GtkActionEntry actions_entries [] = {
	{"quit", GTK_STOCK_QUIT, _("Quit"), NULL, _("Quit D�BR"), (GCallback)on_quit_activate},
	/* menu */
	...
	{"menu_close", GTK_STOCK_CLOSE, NULL, NULL, _("Remove selecteds menus from list"),
	...
	{"menu_save", GTK_STOCK_SAVE, NULL, NULL, _("Save selecteds menus"), (GCallback)on_menu_save_activate},
	...
	{"menu_delete", GTK_STOCK_DELETE, NULL, NULL, _("Delete selecteds menus files"),
