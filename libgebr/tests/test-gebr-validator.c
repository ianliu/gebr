...
void test_gebr_validator_cyclic_errors(Fixture *fixture, gconstpointer data)
{
	...
	VALIDATE_FLOAT_EXPR_WITH_ERROR("b", GEBR_IEXPR_ERROR, GEBR_IEXPR_ERROR_UNDEF_VAR);
	VALIDATE_FLOAT_EXPR_WITH_ERROR("c", GEBR_IEXPR_ERROR, GEBR_IEXPR_ERROR_UNDEF_VAR);
