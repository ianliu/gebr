				 ...
				 gpointer invocation_hint G_GNUC_UNUSED, gpointer marshal_data)
{
	...
	callback(data1,
		 g_marshal_value_peek_boxed(param_values + 1), g_marshal_value_peek_string(param_values + 2), data2);
}
			      ...
			      gpointer invocation_hint G_GNUC_UNUSED, gpointer marshal_data)
{
	...
	callback(data1,
		 g_marshal_value_peek_boxed(param_values + 1), g_marshal_value_peek_int(param_values + 2), data2);
}
