...
static GtkTreeModel *
generate_completion_model(struct gebr_gui_parameter_widget *parameter_widget);
...
static void gebr_gui_parameter_widget_configure(struct gebr_gui_parameter_widget *parameter_widget)
{
	...
	case GEBR_GEOXML_PARAMETER_TYPE_FLOAT:{
			...
			g_signal_connect(completion, "match-selected", 
					 G_CALLBACK(on_entry_completion_matched), NULL);

			/* Tree Model generated by function and use it as the completion model */
	...
	case GEBR_GEOXML_PARAMETER_TYPE_INT:{
			...
			gtk_entry_completion_set_match_func(completion, gebr_gui_parameter_widget_match_completion, NULL, NULL);
			/* Use model column 0 as the text column */
			gtk_entry_completion_set_text_column (completion, 0);
...
static GtkTreeModel *
generate_completion_model(struct gebr_gui_parameter_widget *widget)
{
	const gchar *keyword;
	GList *compatible;
	GtkTreeIter iter;
